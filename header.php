...
<head>
    ...
    <link rel="icon" href="<?php the_field('swConsultans_favicon', 'option'); ?>">
        ...
        <header id="masthead" class="site-header bg-white">
            <div class="w-full lg:w-10/12 mx-auto">
                <div class="flex items-center p-4">
                    <div class="sitelogo w-9/12 lg:w-2/12">
                        <?php
                    ...
                    if (has_nav_menu('menu-1')) { ?>
                        <div class="site__nav site__nav--main w-full hidden lg:flex lg:w-10/12
            ">
                            <?php
