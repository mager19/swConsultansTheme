<?php
if (!function_exists('swConsultans')) :
    /**
    ...
    */
        load_theme_textdomain('swConsultans', get_template_directory() . '/languages');
    ...
    */
        ...
        register_nav_menus(array(
            'menu-1' => esc_html__('Header', 'swConsultans'),
            'menu-2' => esc_html__('Footer', 'swConsultans'),
        ));
...
add_action('after_setup_theme', 'swConsultans');
...
function swConsultans_get_social_icons()
{
