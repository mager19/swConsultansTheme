 ...
 *
 */
function swConsultans_buttons($atts = [], $content = null)
{
...
add_shortcode('button', 'swConsultans_buttons');


add_shortcode('button', 'fps_buttons');

function swConsultans_displaydate()
{
    return date('Y');
}
add_shortcode('date', 'swConsultans_displaydate');
