...
<div class="container mx-auto py-14">
    <div class="info">
                    ...
                    <div class="social-icons">
                        ...
                        ?>
                                <a href="<?php the_sub_field('social_profile'); ?>" target="_blank" data-link-type="social" data-social-network="<?php echo $social['value']; ?>">
                                    <span class="swConsultansIcon-<?php echo $social['value']; ?>"></span>
                                </a>
                        <?php endwhile;
                        endif; ?>
                    </div>
        ...
        <!-- Pagination -->
        <?php if (function_exists('swConsultans__pagination')) : ?>
            <div class="pagination">
                <?php swConsultans__pagination($posts->max_num_pages, "", $paged); ?>
            </div>
        <?php endif; ?>
        <!-- End Pagination -->
